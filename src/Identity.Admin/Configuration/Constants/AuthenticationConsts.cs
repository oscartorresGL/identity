...
namespace Identity.Admin.Configuration.Constants
{
    public class AuthenticationConsts
    {
        ...
        public const string OidcClientSecret = "fmNc%dfl1!df56";
        ...
        public const string IdentityAdminApiSwaggerClientId = "AdminClientId_api_swaggerui";
        public const string IdentityAdminApiScope = "AdminClientId_api";
